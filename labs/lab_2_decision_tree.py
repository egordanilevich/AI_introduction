...
param_grid_bagging = {'n_estimators': [25, 50, 100, 150, 200, 250]}  # количество деревьев
...
param_grid_rf = {
    'n_estimators': [25, 50, 100, 150, 200, 250, 300, 350],  # Количество деревьев в лесу
    'max_depth': [None, 5, 10, 15, 20, 25],  # Максимальная глубина деревьев
    'min_samples_split': [2, 5, 10, 15],  # Минимальное количество образцов для разделения узла
    'min_samples_leaf': [1, 2, 4, 6, 8],  # Минимальное количество образцов в листовом узле
    'bootstrap': [True, False],  # Использование бутстрепа для обучения деревьев
    'max_features': ['auto', 'sqrt', 'log2'],  # Количество признаков для выбора при разбиении
    ...
    #'random_state': [3],  # Сид для генератора случайного числа
